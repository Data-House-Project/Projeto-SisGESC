...
curso (1) — (N) professor_curso (N) — (1) professor 

curso (1) — (N) coordenador 

professor (1) — (1) coordenador 

disciplina (1) — (N) turma 

professor (1) — (N) turma 

turma (1) — (N) matricula_turma (N) — (1) aluno 

matricula_turma (1) — (1) desempenho 
...
funcionario (1) — (1) dados_trabalhistas 
...
folha_pagamento (1) — (N) item_folha (N) — (1) rubrica 

funcionario (1) — (N) vinculo_beneficio (N) — (1) beneficio 

funcionario (1) — (N) vinculo_sindicato (N) — (1) sindicato 

matricula_curso (1) — (1) contratos_educacionais 

contratos_educacionais (1) — (N) mensalidade 

mensalidade (1) — (1) inadimplencia 

pessoa (1) — (N) contas_receber 

contas_receber (1) — (N) contas_receber_mensalidade (N) — (1) mensalidade 

contas_receber (1) — (N) pagamento_recebido 

fornecedor (1) — (N) contas_pagar 

funcionario (1) — (N) contas_pagar 

contas_pagar (1) — (N) pagamento 

pessoa_juridica (1) — (1) fornecedor 

pessoa_juridica (1) — (1) parceiro_comercial 

pessoa_juridica (1) — (1) empresa_terceirizada 

funcionario (1) — (N) ativo_equipamento 

ativo_equipamento (1) — (N) alocacao_ativo_local (N) — (1) espaco_fisico 

parceiro_comercial (1) — (N) contrato_espaco (N) — (1) espaco_fisico 
...
pessoa (1) — (N) intercambio_internacional 

pessoa (1) — (N) premiacao_honraria 

conselho_colegiado (1) — (N) membro_conselho (N) — (1) pessoa 

departamento (1) — (N) conselho_colegiado 
